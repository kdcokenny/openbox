...
def build_request(headers: Headers) -> str:
    ...
    Args:     headers: Handshake request headers.

    Returns:     str: ``key`` that must be passed to :func:`check_response`.
    """
    key = generate_key()
...
def check_request(headers: Headers) -> str:
    ...
    Returns:     str: ``key`` that must be passed to :func:`build_response`.
...
def build_response(headers: Headers, key: str) -> None:
    ...
    Args:     headers: Handshake response headers.     key: Returned by
    :func:`check_request`.
    """
    headers["Upgrade"] = "websocket"
    headers["Connection"] = "Upgrade"
